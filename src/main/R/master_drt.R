...
for (drtMode in drt.modes){
  ...
  if (x_drt_demand ==1) {
    ...
    write.csv(df.demand.drtMode, file = paste0(outputDirectoryScenarioDrt, "/table.demand.", drtMode, ".csv"))
  ...
  if (x_drt_performance) {
    ...
    write.csv(df.performance.drtMode, file = paste0(outputDirectoryScenarioDrt, "/table.performance.", drtMode, ".csv"))
    ...
    write.csv(df.waiting.time.drtMode, file = paste0(outputDirectoryScenarioDrt, "/table.waitingtime.", drtMode, ".csv"))
...
if (x_drt_performance == 1) {
  ...
  write.csv(df.waiting.time, file = paste0(outputDirectoryScenarioDrt, "/table.waitingtime.csv"))
}
