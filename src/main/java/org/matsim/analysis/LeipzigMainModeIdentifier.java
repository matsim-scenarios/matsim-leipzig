...
/**
 * Determine main mode of a trip.
 */
public final class LeipzigMainModeIdentifier implements AnalysisMainModeIdentifier {
	...
	private static final Logger log = LogManager.getLogger(LeipzigMainModeIdentifier.class);
